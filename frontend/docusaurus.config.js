    ...
    // /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
        {
            ...
            algolia: {
                ...
                // history.push. Useful when our Algolia config crawls multiple documentation sites, and we want to
                // navigate with window.location.href to them.
                externalUrlRegex: 'external\\.com|domain\\.com',

                // Optional: Replace parts of the item URLs from Algolia. Useful when using the same search index
                // for multiple deployments using a different baseUrl. You can use regexp or string in the `from`
                // param. For example: localhost:3000 vs myCompany.com/docs
