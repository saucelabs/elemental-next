...
In this example we are going to take the following example code from a previous tip ([Exporting from Selenium IDE](http://elementalselenium.com/tips/6-export-from-selenium-ide))==**`!! Link needs replacing !!`**== and upgrade it with the use of a Page Object.
