...
title: 'SafariDriver'
id: '69-safari-driver'
slug: /69-safari-driver
sidebar_label: SafariDriver
description: 'Since Selenium 2.45.0, in order to use SafariDriver, you need to manually install the SafariDriver browser extension.'
number: 69
...
<DisplayTips contentPath={"69-safari"} languages={[
