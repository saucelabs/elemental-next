...
Lines 3 to 10 are pulling in our requisite classes
...
Lines 16-18 show our first test. In it, we'll step through [an example of nested frames](http://the-internet.herokuapp.com/nested_frames) from
...
It was just a brief example.  
Selenide has more methods for working with frames, check these
* `switchTo().innerFrame()`
