...
description: "In this tip, you'll learn how to work with frames and write tests against them."
number: 3
...
<DisplayTips contentPath={"3-work-with-frames"} languages={[
    ...
    {label: 'Serenity/JS', value: 'serenity-js'},
]}/>
...
<DefaultAvatar
    name="Jan Molak"
    imgSrc={"https://github.com/jan-molak.png"}
    description={"Contributed the Serenity/JS code for this tip."}
