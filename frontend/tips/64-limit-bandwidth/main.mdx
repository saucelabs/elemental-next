...
>
>BrowserMob Proxy is a server which sits between your browser and the application you're testing. You connect
>to it by configuring a browser profile to pass through it. As listed on
...
<DisplayTips contentPath={"64-limit-bandwidth"} languages={contentLanguages} />
