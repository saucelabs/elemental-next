...
description: 'Working with Selenium straight in code has its advantages. However, if you run into a complicated scenario to automate, it becomes challenging to work through it to completion.'
number: 11
...
<DisplayTips contentPath={"11-build-an-interactive-prompt"} languages={[
