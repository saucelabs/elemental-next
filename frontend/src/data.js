const Data = [
    ...
    { 
        ...
        text: "Selecting from a dropdown list seems like one of those simple things. However, there is a bit more finesse to it." , difficulty: "Beginner", 
    ...
    { 
        ...
        headline: "Retrying Test Actions", 
