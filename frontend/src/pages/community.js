  ...
  return (
    <Layout title='Elemental Selenium Commmunity' description='Get involved as community or contributor'>
      <div className='community-wrapper'>
        ...
        <p>
          Elemental Selenium extends beyond our weekly mailing list. We’re open on GitHub for contributions to the site
          and for the first time, our tips are fully open source!
        </p>
        <table>
          <tr>
            <td>
