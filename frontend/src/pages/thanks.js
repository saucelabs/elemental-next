  ...
  return (
    <Layout title='Thank you for signing up' description='Confirmation message for signing up to our newsletter'>
      <div className='thanks-container'>
        ...
        <h2>What's next?</h2>
        <p>
          Every Tuesday you’ll get an email containing one tip or trick in the coding language you’ve selected. If you’d
          like more, head on over to the <a href='/tips'>tips page</a> and read them all at any time!
        </p>
        <p>
          While you’re there, consider <a href='/community'>joining our community</a> and maybe next Tuesday the tip in
          everyone’s inbox will be yours!
        </p>
      </div>
